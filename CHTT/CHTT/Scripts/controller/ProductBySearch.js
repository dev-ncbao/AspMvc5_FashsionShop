...
var ProductBySearch = {
    init: function () {
        ProductBySearch.loadProductListBySearch();
        ProductBySearch.registerEvent();
    },
    ...
    loadProductListBySearch: function () {
        $.ajax({
            url: '/Home/LoadListProductBySearch',
            type: 'GET',
            dataType: 'json',
            data: {
                strSearchString: $('#txt-SearchString').data('string'),
                skip:curcount
            },
