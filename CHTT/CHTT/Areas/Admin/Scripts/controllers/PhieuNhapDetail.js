...
var PhieuNhapDetail = {
    ...
    registerEvents: function () {
        ...
        $(document).off('click', '.detail-button').on('click', '.detail-button', function () {
            var MaSP = $(this).data('id');
            location.href = '/Admin/AdminSanPham/AddOrEdit/?strID=' + MaSP;
            PhieuNhapDetail.registerEvents();
        });
    ...
    deleteDetailRecord: function (strMaSP,strMaPN) {
        $.ajax({
            url: '/Admin/AdminPhieuNhap/DeleteDetailRecord',
            type: 'POST',
            dataType: 'json',
            data: {
                strMaPN: strMaPN,
    ...
    getDetailEditData: function (strMaSP,strMaPN) {
        $.ajax({
            url: '/Admin/AdminPhieuNhap/GetDetailEditData',
            type: 'GET',
            dataType: 'json',
            data: {
                strMaPN: strMaPN,
    ...
    reloadInformation: function (strMaPN) {
        $.ajax({
            url: '/Admin/AdminPhieuNhap/ReloadInformation',
            type: 'GET',
            dataType: 'json',
            data: {
                strMaPN: strMaPN
    ...
    submitAOEForm: function (isAdd) {
        ...
        $.ajax({
            url: '/Admin/AdminPhieuNhap/AddOrEditDetail',
            type: 'POST',
            dataType: 'json',
            data: {
                model: model,
    ...
    getNextProductID: function () {
        $.ajax({
            url: '/Admin/AdminPhieuNhap/GetNextProductID',
            type: 'GET',
            dataType: 'json',
            success: function (response) {
                if (response.status) {
    ...
    getDetailModal: function () {
        $.ajax({
            url: '/Admin/AdminPhieuNhap/AOEDetailModal',
            type: 'GET',
            success: function (response) {
    ...
    submitInformationForm: function () {
        ...
        $.ajax({
            url: '/Admin/AdminPhieuNhap/AddOrEdit',
            type: 'POST',
            dataType: 'json',
            data: {
                model: model,
    ...
    loadDetailTableData: function () {
        dataTable = $('#PNTable').DataTable({
            ajax: {
                url: '/Admin/AdminPhieuNhap/LoadDetailTableData',
                type: 'GET',
                dataType: 'json',
                data: {
            ...
            columns: [
                ...
                },
                {
                    data: 'MaSP',
                    render: function (data) {
                        return "<button class='btn btn-secondary detail-button'  data-id='" + data + "'><i class='fa fa-wrench' style='margin-right:.3rem' aria-hidden='true'></i>CTSP</button><button class='btn btn-primary edit-button'  data-id='" + data + "'><i class='fa fa-wrench' style='margin-right:.3rem' aria-hidden='true'></i>Sửa</button><button class='btn btn-danger delete-button' data-id='" + data + "'><i class='fa fa-trash' style='margin-right:.3rem' aria-hidden='true'></i>Xóa</button>";
                    },
